...
int main(void) {
  ...
  char *identificador = malloc(sizeof(char*)*12);
  //argumentos opcionais
  char *espacamentoLateral = malloc(sizeof(char*)*12) ;
  char *qtdPixels = malloc(sizeof(char*)*12);
  char *alturaCodigo = malloc(sizeof(char*)*12);
  char *nomeArquivo = malloc(sizeof(char*)*500);
